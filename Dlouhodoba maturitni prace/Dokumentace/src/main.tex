...
\end{figure}
	...
	Při registraci se uživatel automaticky přiřadí do této role. Děje se tak při registraci, kde vyvolám objekt \_userManager s operaci AddToRoleAsync (viz zdrojový kód \ref{AddToRole}) a ta přidá uživatele do role z parametru.
